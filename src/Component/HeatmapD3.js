...
const HeatmapD3 = ({ baseline, occupantNumber, floorArea, height }) => {
...
<br />
    ...
    <>
      ...
      >
        NADR {hoveredNADR}/h&emsp;Filter: {hoveredFilter}%&emsp;OA: {hoveredOA}<br/>Absolute Risk: {hoveredAR}%&emsp;Relative Risk: {hoveredRR}
      </span>
    </>
  )}
</div>
